...
#define PI 3.14159
const int FREQ_ECHANTILLONAGE= 8000; //ne peut être modifié sans modifier le fichier wave.c

//constantes modifiables
#define NB_SEC 5 //nombres de secondes de notre fichier wav
const int FREQ_NOTE_EN_HERTZ = 150; // partie paramétrable pour générer une sinuoide
...
int main(void) {
    ...
    unsigned char data[nbEchantillon]; //création du tableau dynamiquement (VLA)
